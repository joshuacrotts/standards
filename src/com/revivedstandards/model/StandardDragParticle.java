...
public class StandardDragParticle extends StandardParticle {
    ...
    public StandardDragParticle(double x, double y, double life, StandardParticleHandler handler) {
    ...
    public StandardDragParticle(double x, double y, double life, StandardParticleHandler handler, Color c) {
    ...
    public StandardDragParticle(double x, double y, double life, StandardParticleHandler handler, Color c, double rotationAngle) {
