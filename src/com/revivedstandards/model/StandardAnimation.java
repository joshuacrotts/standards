...
public final class StandardAnimation
{
     ...
     * be one higher than what your indexes say. In the above example, to
     * tell the animation to loop through the walking left frames, the 
     * function call would be setFramePositions(0, 4), as the algorithm
     * will iterate over frames 0, 1, 2, and 3.
     *
     * @param startIndex
     * @param endIndex
     */
