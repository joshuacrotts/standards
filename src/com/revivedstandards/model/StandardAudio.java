...
/**
 * StandardAudio is a defined object that has an audio clip. 
 * These objects should never be directly instantiated by the programmer;
 * they should only be instantiated by the controller, via load().
 */
public final class StandardAudio
{
    ...
    /**
     * Loads an audio track from the system into the audio buffer
     * and prepares it for play.
     * 
     * If the user attempts to load in a clip when the audio buffer is
     * full, an IllegalStateException is thrown.
     * 
     * @param fileName 
     */
