...
public abstract class StandardDraw {
     ...
     * @param y
     */
    public static void drawImage(BufferedImage image, double x, double y) {
     ...
     * @param color
     */
    public static void drawText(String text, int x, int y, String font, float size, Color color) {
     ...
     * @param color
     */
    public static void drawText(String text, int x, int y, Font font, float size, Color color) {
        Font oldFont = StandardDraw.Renderer.getFont();
        Color oldColor = StandardDraw.Renderer.getColor();
     ...
     */
    public static void drawRectangle(double x, double y, double width, double height, Color color, boolean fill) {
        if (color == null) {
            color = Color.black;
        }
     ...
     */
    public static void drawEllipse(double x, double y, double width, double height, Color color, boolean fill) {
        if (color == null) {
            color = Color.black;
        }
        if (fill) {
     ...
     * @param obj
     */
    public static void renderObject(StandardGameObject obj) {
     ...
     * @param handler
     */
    public static void renderHandler(StandardHandler handler) {
