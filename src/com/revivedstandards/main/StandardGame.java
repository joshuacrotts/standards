...
public abstract class StandardGame extends Canvas implements Runnable {
    ...
    public void run() {
        ...
        while (this.running) {
            ...
            if (renderable) {
                ...
                this.render();
                this.getWindow().getFrame().getToolkit().sync();
    ...
    /**
     * Returns the game width (frame width).
     * @return 
     */
    ...
    /**
     * Returns the game height (frame height).
     * @return 
     */
     ...
     * shape without having to offset it, this is what you want.
     */
    public int getContentPaneWidth() {
        return (int) this.getWindow().getFrame().getContentPane().getWidth();
    }
    
    public int getContentPaneHeight() {
        return (int) this.getWindow().getFrame().getContentPane().getHeight();
    }
