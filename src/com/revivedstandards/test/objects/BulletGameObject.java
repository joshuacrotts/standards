...
public class BulletGameObject extends StandardGameObject implements DeathListener {
	...
	public BulletGameObject(FollowTheMouseGameTest sg, StandardCollisionHandler parentContainer, StandardCamera sc,
			TriangleGameObject parent, int x, int y) {
	...
	public void uponDeath() {
		this.playRandomExplosionSFX(StdOps.randomInt(0, 2));
