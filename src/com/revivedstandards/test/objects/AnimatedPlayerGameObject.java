...
public class AnimatedPlayerGameObject extends StandardGameObject {
    ...
    public AnimatedPlayerGameObject(StandardGame sg, StandardCamera sc, int x, int y) {
        ...
        StandardAnimatorController leftController = new StandardAnimatorController(( new StandardAnimation(this, leftFrames, StdOps.rand(10, 30), 16) ));
        StandardAnimatorController rightController = new StandardAnimatorController(( new StandardAnimation(this, rightFrames, StdOps.rand(10, 30), 16) ));
