...
public class UserInterface implements Renderable, Updatable {
    ...
    public void render(Graphics2D g2) {
        ...
        StandardDraw.drawText("GAME", this.renderX + this.sg.getGameWidth() / 2, this.renderY + 50, this.gameFont, 36f, Color.yellow);
        StandardDraw.drawText("FPS: " + this.sg.getFPS(), this.renderX + 50, this.renderY + 50, this.gameFont, 20f, Color.yellow);
        StandardDraw.drawText("Beta Testing Purposes ONLY", this.renderX + this.sg.getGameWidth() - 380, this.renderY + 50, this.gameFont, 20f, Color.yellow);

        // Actual Player info
        StandardDraw.drawText("Ammo: " + this.obj.getBulletCount(), this.renderX + 50, this.renderY + 75, this.gameFont, 20f, Color.yellow);
    ...
    private void renderPauseScreen(Graphics2D g2) {
        ...
        StandardDraw.drawText("PAUSED", (int) this.renderX + this.sg.getGameWidth() / 2,
