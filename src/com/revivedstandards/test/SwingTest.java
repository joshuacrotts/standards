...
import com.revivedstandards.main.StandardSwingApplication;
...
public class SwingTest extends StandardSwingApplication {
	...
	/* Instance variable that is incremented via the timer to
	...
	/**
	 * This class is a JPanel to test the paintComponent method,
	 * since you can't draw directly to the JFrame. Normally, a separate
	 * component like a JPanel would be its own individual class, not listed
	 * as private. This is just for demonstrative purposes.
	 * 
	 * @author Joshua
	 */
