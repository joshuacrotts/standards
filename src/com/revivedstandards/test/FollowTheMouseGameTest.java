...
/**
 * This class is an example of how to make a very basic game using Standards.
 *
 * It's a simple space-shooter game, where the main sprite follows the mouse.
 *
...
public class FollowTheMouseGameTest extends StandardGame {
    ...
    public void render() {
        ...
        StandardDraw.renderObject(this.sc);

        // Then render all game objects
        StandardDraw.renderHandler(this.sch);
